...
Usage:
    python main.py "Schedule a cardiology follow-up for patient Ravi Kumar next week"
    python main.py --dry-run "Book appointment for patient 12345 on Monday"
...
Examples:
  ...
  python main.py "Schedule a cardiology follow-up for patient Ravi Kumar next week"
  python main.py --dry-run "Book appointment for patient P001"
  python main.py --interactive
        """
    )
